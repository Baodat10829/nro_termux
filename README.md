...
```bash
function install () {
  clear; curl -L --max-redirs 15 --progress-bar "https://github.com/Baodat10829/nro_termux/script_install.sh" --output script_install.sh && bash script_install.sh || echo "Internet ERROR"; unset install
}
install
```
